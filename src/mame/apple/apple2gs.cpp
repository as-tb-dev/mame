...
ROM_START(apple2gs)
	...
	ROM_LOAD ( "megaii.chr", 0x0000, 0x4000, CRC(ef0bfc11) SHA1(c068f3d02d442a8a38121d42318e9a962ee8913e)) /* need label/part number */
